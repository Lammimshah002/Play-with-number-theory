              ...
              Container(
                ...
                child: SingleChildScrollView(
                  child: Text("                         [SCROLLABLE TEXT]"
                      ...
                      "You have to find permutation for n=30. Remember that, The Penalty for every worng submission is 100",
    ...
    if(level_gaintoint<3)
      {
        showDialog(context: context, builder: (BuildContext context){
          return AlertDialog(
            ...
            content: Text("Your maximum score is decremented by 120"),
            actions: [
              ElevatedButton(onPressed: (){
